...
import com.farsight.golf.asyn.ImageLoadAsync;
import com.farsight.golf.asyn.MediaAsync;
import com.farsight.golf.asyn.VideoLoadAsync;
import com.farsight.golf.ui.video.LocalVideoActivity;
import com.farsight.golf.ui.video.MediaModel;
...
public class GridViewAdapter extends ArrayAdapter<MediaModel> {
	public LocalVideoActivity videoFragment;  
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(mIsFromVideo){
			...
			executeOnExecutor(MediaAsync.THREAD_POOL_EXECUTOR, mGalleryModelList.get(position).url.toString());
