...
import com.farsight.golf.util.GalleryCache;
import com.farsight.golf.util.GalleryRetainCache;
...
public class VideoLoadAsync extends MediaAsync<String,String, String>{
	...
	@SuppressLint("NewApi")
	public VideoLoadAsync(LocalVideoActivity videoFragment, ImageView imageView, boolean isScrolling, int width) {
		mImageView    = imageView;
		this.fragment = videoFragment;
		mWidth        = width;
		mIsScrolling  = isScrolling;

		final int memClass = ((ActivityManager) videoFragment.getSystemService(Context.ACTIVITY_SERVICE))
				.getMemoryClass();
