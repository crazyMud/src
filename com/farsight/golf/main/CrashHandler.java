...
public class CrashHandler implements UncaughtExceptionHandler {
	public final static String LOG_PATH = Configuration.RESOURCE_PATH + "log/";
	...
	private String saveCrashInfo2File(Throwable ex) {
		...
		try {
			...
			// fileName = "crash-ihome-error.log";
			if (Environment.getExternalStorageState().equals(
				 ...
				 * fos.write(sb.toString().getBytes()); fos.flush();
				 * fos.close();
				 */
			}
			return fileName;
