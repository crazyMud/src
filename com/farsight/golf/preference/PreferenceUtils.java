package com.farsight.golf.preference;
...
public final class PreferenceUtils {
	...
	public PreferenceUtils() {
		this(MainApplication.getInstance(), PreferenceKeys.PERFERENCE);
	}
	...
	public static String getString(String key, String defValue) {
		if (MainApplication.getInstance() != null) {
			return PreferenceManager.getDefaultSharedPreferences(MainApplication.getInstance()).getString(key, defValue);
		}
		return defValue;
	}
	...
	public static long getLong(String key, long defValue) {
		if (MainApplication.getInstance() != null) {
			return PreferenceManager.getDefaultSharedPreferences(MainApplication.getInstance()).getLong(key, defValue);
		}
		return defValue;
	}
	...
	public static float getFloat(String key, float defValue) {
		if (MainApplication.getInstance() != null) {
			return PreferenceManager.getDefaultSharedPreferences(MainApplication.getInstance()).getFloat(key, defValue);
		}
		return defValue;
	}
	...
	public static int getInt(String key, int defValue) {
		if (MainApplication.getInstance() != null) {
			return PreferenceManager.getDefaultSharedPreferences(MainApplication.getInstance()).getInt(key, defValue);
		}
		return defValue;
	}
	...
	public static boolean getBoolean(String key, boolean defValue) {
		if (MainApplication.getInstance() != null) {
			return PreferenceManager.getDefaultSharedPreferences(MainApplication.getInstance()).getBoolean(key, defValue);
		}
		return defValue;
	}
	...
	public static void putStringProcess(String key, String value) {
		if (MainApplication.getInstance() != null) {
			SharedPreferences sharedPreferences = MainApplication.getInstance().getSharedPreferences("preference_mu", Context.MODE_MULTI_PROCESS);
			Editor editor = sharedPreferences.edit();
	...
	public static void remove(String... keys) {
		if (keys != null && MainApplication.getInstance() != null) {
