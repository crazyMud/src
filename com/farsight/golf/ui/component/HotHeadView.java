...
public class HotHeadView extends LinearLayout implements OnGestureListener {
	static String TAG = "HotHeadView";
    ...
    public HotHeadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    ...
    private void init(Context context) {
        ...
        headView = (LinearLayout) inflater.inflate(R.layout.tab_content_head, this);
