...
import com.farsight.golf.ui.BaseActivity;
import com.farsight.golf.ui.component.CommonIntentExtra;
import com.farsight.golf.ui.component.views.ThemeGroupLayout;
import com.farsight.golf.ui.component.views.ThemeSufaceView;
import com.farsight.golf.ui.component.views.ThemeView;
import com.farsight.golf.ui.helper.ThemeHelper;
import com.farsight.golf.ui.po.POThemeSingle;
import com.farsight.golf.util.ConvertToUtils;
import com.farsight.golf.util.IsUtils;
import com.farsight.golf.util.ToastUtils;
...
public class MediaPreviewActivity extends BaseActivity implements OnClickListener, UtilityAdapter.OnNativeListener {
	...
	private void onEncodingEnd() {
		...
		startActivity(new Intent(this, VideoPublishActivity.class).putExtra("path", mVideoPath));
		finish();
	}
