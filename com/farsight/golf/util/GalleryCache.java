...
public class GalleryCache {
	 ...
	 */
	public void loadBitmap(Activity mainActivity, String imageKey,
		...
		if (bitmap != null) {
			...
			if (!isScrolling && !mCurrentTasks.contains(imageKey)) {
				if(mainActivity instanceof LocalVideoActivity){
					BitmapLoaderTask task = new BitmapLoaderTask(imageKey, ((LocalVideoActivity)mainActivity).getAdapter());
					task.execute();
