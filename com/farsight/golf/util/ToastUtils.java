...
public class ToastUtils {
	...
	public static void showToast(int resID) {
		showToast(MainApplication.getInstance(), Toast.LENGTH_SHORT, resID);
	}

	public static void showToast(String text) {
		showToast(MainApplication.getInstance(), Toast.LENGTH_SHORT, text);
	}
	...
	public static void showLongToast(int resID) {
		showToast(MainApplication.getInstance(), Toast.LENGTH_LONG, resID);
	}
	...
	public static void showLongToast(String text) {
		showToast(MainApplication.getInstance(), Toast.LENGTH_LONG, text);
	}
